...
COV_DIR="${OUT_PATH}/Sample_${SAMPLE_ID}/${COV_OUT_DIR_NAME}"
DUP_FREE_BAM_DIR="${OUT_PATH}/Sample_${SAMPLE_ID}/${DUP_FREE_BAM_DIR_NAME}"

DUP_FREE_BAMhg38="${DUP_FREE_BAM_DIR}/${SAMPLE_ID}_nodups.bam"
...
perl "${SCRIPTPATH}/Coverage_from_pileup.pl" --inPath1 $COV_DIR --inPath2 $COV_DIR --inFile $PILEUP_NODUPS_FILEhg38 --batchID ${Library_ID} --targets $TARGETS
