...
SAMVCF="${INDIR}/${SAMPLE_ID}_SourceBio_Q${Q}_Bcftools13_${REF_BUILD}_${CHRFULL}.vcf"
...
samtools mpileup -vu -d $MaxD -q $Q -Q $Q -t DP,AD,ADF,ADR,SP -r ${CHRFULL} -f ${REF_FILE} -b ${BAMFILELIST} | bcftools call -v -m -f GQ,GP -O v -o $SAMVCF -
